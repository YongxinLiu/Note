...
open F1,"<$opts{i}";   ### bed-format
 #1       rep14   repeat  122688613       122690014       1354    -       .       ID=ath-rep86027;Note=Satellite/centr;Annotation=CENTC_ZM
open OUT,">$opts{o}";
 while(<F1>){
	my @tmp=split/\t/;
	$m=$tmp[0];
...
sub usage {
    die(
        qq/
Usage:    filter_gff_region.pl -i gff -o gff -p centromere_position
