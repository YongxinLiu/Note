...
while(<>) {
  ...
  if(/^\w/) {  # dont assume blast input has comments .. -m8
    my @v= split "\t";
	# 按行读取信息 13strand 14qcovs 15qcovhsp
#Alyrata|Al_scaffold_0001_1131	1	100.00	239	0	0	1	239	4506406	4505690	7e-158	 495	N/A	100	80
#Alyrata|Al_scaffold_0001_1131	1	57.28	213	74	2	27	239	5752015	5751428	1e-71	 246	N/A	100	71
#Alyrata|Al_scaffold_0001_1131	1	45.27	296	135	6	18	288	4523142	4522261	1e-69	 240	N/A	100	91
    my ($qid, $sid, $pctident, $alignment_length, $mismatches, $gap_openings, 
       $q_start, $q_end, $s_start, $s_end, $prob, $bit_score, $strand, $qcovs, $qcovhsp ) = @v;
