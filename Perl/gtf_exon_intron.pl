...
sub usage {
    die(
        qq/
Usage:    gtf_exon_intron.pl -i gtf file (exon, cds, start-codon ...) -o gtf file (exon and intron)
Function: get standard gtf file, and output only contain exon and intron lines in bed
