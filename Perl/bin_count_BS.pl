...
sub usage {
    die(
        qq/
Usage:    bin_count_BS.pl -i CGmap -o bin_average -c chromosome -s start -e end -b bin_size -l slid_size
Function: count each slid windows average mC & C methyl level
