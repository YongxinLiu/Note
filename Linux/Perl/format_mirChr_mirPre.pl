...
sub usage {
    die(
        qq/
Usage:    format_mirChr_mirPre.pl.pl -i miR gff3 -o mir Bed
Function: Format mature miRNA chromosome position to pre-miRNA position, based on miRbase gff3 file
