...
sub usage {
    die(
        qq/
Usage:    intersect_bedgff_rpm.pl -i cluster -d intersect_gff_result -o RPM -t loci_file
Function: get the intersect result into normalized RPM
