...
输入文件有标准化OTU表(otutab_norm.txt)+分组信息(design.txt)

输入文件"-i", "--input"，Input norm otutab; 标准化OTU表；

分类级别"-t", "--type"，Distance type; 距离类型, 可选manhattan, euclidean, canberra, **bray**, kulczynski, **jaccard**, gower, altGower, morisita, horn, mountford, raup , binomial, chao, cao or mahalanobis；
